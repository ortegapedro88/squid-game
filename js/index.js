...
canvas.onclick = function (){if(!game.continueGame){       // restart game 
    game.init();
}}
...
//             if(arrowLeft && !player1.realDeath){player1.x -= moveSpeed*player1.tl;}
//             if(arrowRight && !player1.realDeath){player1.x += moveSpeed*player1.tr;}
//     if(arrowUp && !player1.realDeath){player1.y -= moveSpeed*player1.tu;}
//     if(arrowDown && !player1.realDeath){ player1.y += moveSpeed*player1.td;}
//     if(keyA && !player2.realDeath){player2.x -= moveSpeed*player2.tl;}
//     if(keyD && !player2.realDeath){player2.x += moveSpeed*player2.tr;}
//     if(keyW && !player2.realDeath){player2.y -= moveSpeed*player2.tu;}
//     if(keyS && !player2.realDeath){ player2.y += moveSpeed*player2.td;}
